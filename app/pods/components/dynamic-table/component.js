...
export default Ember.Component.extend({
	...
	gotoBackEnabled: computed('currentPageNumber', 'prevEnabled', function(){
		return get(this, 'currentPageNumber') > 1;
	}),

	//botones "Next" y "Last" activados, también vale para saber si es la última página
	gotoForwardEnabled: computed('currentPageNumber', 'pagesCount', 'nextEnabled', function () {
